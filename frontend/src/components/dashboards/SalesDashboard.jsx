    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Card hoverEffect={false} className="border-blue-100 dark:border-blue-900/30 shadow-md">
        ...
        <div className="p-3 mb-2 rounded-xl bg-gradient-to-r from-blue-950/40 via-indigo-950/30 to-slate-900/40 border border-blue-500/20 flex flex-wrap items-center justify-between gap-2 text-xs">
          <div className="flex items-center gap-2">
            <span className="font-bold text-slate-200">📅 Today's Booked Orders:</span>
            <span className="text-slate-400 font-medium">({deliveryStats.todayTotalCount} Orders today)</span>
          </div>
